...
register('chat', '-', ['INSERT'], chat_manager.on_chat_add)
register('chat', '-', ['INSERT'], chat_message_manager.on_chat_add)
register('chat', '-', ['MODIFY'], chat_manager.on_chat_user_count_change, {'userCount': 0})
register('chat', '-', ['MODIFY'], chat_message_manager.on_chat_name_change, {'name': None})
...
register('chat', 'member', ['INSERT'], chat_manager.on_chat_member_add)
register('chat', 'member', ['INSERT'], chat_message_manager.on_chat_member_add)
...
register('chat', 'member', ['REMOVE'], chat_manager.on_chat_member_delete)
register('chat', 'member', ['REMOVE'], chat_message_manager.on_chat_member_delete)
