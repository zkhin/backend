...
from migrations.media_object_0_to_1 import Migration
...
def test_migrate_media_object_s3_objects_copied_correctly(dynamo_table, s3_bucket, caplog, media_object_with_s3):
