...
| - | - | - | - | - | - | - | - | - | - | - | - | - | - |
| `user/{userId}` | `profile` | `5` | `userId`, `username`, `email`, `phoneNumber`, `fullName`, `bio`, `photoMediaId`, `privacyStatus`, `followerCount:Number`, `followedCount:Number`, `postCount:Number`, `lastManuallyReindexedAt`, `languageCode`, `themeCode`, `placeholderPhotoCode`, `signedUpAt`, `acceptedEULAVersion`, `followCountsHidden:Boolean`, `postViewedByCount:Number`, `usernameLastValue`, `usernameLastChangedAt` | `username/{username}` | `-` |
