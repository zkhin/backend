...
test('Add, read, and delete an album', async () => {
  ...
  expect(album['art']['url']).not.toBeNull()
  expect(album['art']['url4k']).not.toBeNull()
...
test('Album art generated for 0, 1 and 4 posts in album', async () => {
  ...
  expect(albumOnePost['art']['url']).not.toBeNull()
  expect(albumOnePost['art']['url4k']).not.toBeNull()
  ...
  expect(albumTwoPosts['art']['url']).not.toBeNull()
  expect(albumTwoPosts['art']['url4k']).not.toBeNull()
  ...
  expect(albumThreePosts['art']['url']).not.toBeNull()
  expect(albumThreePosts['art']['url4k']).not.toBeNull()
  ...
  expect(albumFourPosts['art']['url']).not.toBeNull()
  expect(albumFourPosts['art']['url4k']).not.toBeNull()
