...
| `user/{userId}` | `follower/{userId}/firstStory` | `1` | `postedByUserId`, `postId` | `followedFirstStory/{followerUserId}` | `{expiresAt}` | `follower/{followerUserId}/firstStory` | `{expiresAt}` |
