...
| `chat/{chatId}` | `view/{userId}` | `0` | `firstViewedAt`, `lastViewedAt`, `viewCount` | `chatView/{chatId}` | `{firstViewedAt}` | `chatView/{userId}` | `{firstViewedAt}` | | | | | `chat/{chatId}` | `view/{firstViewedAt}` |
...
| `post/{postId}` | `view/{userId}` | `0` | `firstViewedAt`, `lastViewedAt`, `viewCount` | `postView/{postId}` | `{firstViewedAt}` | `postView/{userId}` | `{firstViewedAt}` | | | | | `post/{postId}` | `view/{firstViewedAt}` |
